...
func (s *submitService) Get(ctx context.Context, name string, opts *v1.GetOptions) (*v1.Submit, error) {
	return s.store.Submits().Get(ctx, name, opts)
}
...
func (s *submitService) Delete(ctx context.Context, name string, opts *v1.DeleteOptions) error {
	return s.store.Submits().Delete(ctx, name, opts)
}
